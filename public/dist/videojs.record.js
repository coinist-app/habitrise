        ...
        switch (recordType) {
          ...
          case _recordMode.SCREEN_ONLY:
            if (recording.video !== undefined) {
              ...
              console.log('##Blob##  ', recording.video);
            }
...
var Record = function (_Plugin) {
  ...
  function Record(player, options) {
    ...
    if (options !=null && options.hasOwnProperty('formatTime') && options.formatTime && typeof options.formatTime === 'function') {
  ...
  (0, _createClass2.default)(Record, [{
    ...
    value: function setupUI() {
      ...
      //setTimeout(function(){alert(7);this.player.trigger(_event.default.FINISH_RECORD)}.bind(this), 1000);
    }
  }, {
    key: "isRecording",
    ...
    //alert(9);
      ...
      //this.startRecording();
      //setTimeout(function(){this.stop(); }.bind(this),30000);
      //setTimeout(function(){console.log('url--',document.getElementById('myVideo_html5_api').src);},31000);
      window.addEventListener('beforeunload', function(){this.stop()}.bind(this))
    }
  }, {
    key: "onDeviceError",
